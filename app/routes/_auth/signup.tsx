...
import { z } from "zod";
import { Loader2, Shield, UserPlus, ArrowLeft, Eye, EyeOff } from "lucide-react";
...
import { signUp as signUpApi } from "~/features/auth/api/auth";
...
export function meta(_args: Route.MetaArgs) {
  return [
    ...
    { name: "description", content: "Create a new admin account" },
  ];
}
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-muted-foreground">
              Get started with your admin dashboard account
            </p>
          </div>
